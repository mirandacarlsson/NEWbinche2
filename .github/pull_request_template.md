...
Please describe the tests that were added or modified to verify this change:
...
- [ ] All linting checks pass: `uv run prek --all-files`
...
- [ ] Docstrings updated for new/changed APIs
